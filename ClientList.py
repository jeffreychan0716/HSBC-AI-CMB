...
if st.button("Generate Report"):
    if user_input_industry and user_input_regions:
        ...
        # Create the prompt
        if document_text:
            prompt = f"Generate me a report that includes 1) latest industry market trend with data, 2) Profitability of the industry, 3) Potential financial products HSBC can provide to companies in this industry with rationale ,4) top 100 companies in the {user_input_industry} industry in table format (include chinese, english name, stock code if listed, market capitalization, revenue in USD, office headquarter, webiste, what business they are doing, business breakdown by region (make it up), contact person (make it up if you have no information), phone number(make it up if you have no information)), only include those companies based in {user_input_regions}. Use your own knowledge, internet sources, and the following document: {document_text}. Additionally, include information from these search results: {search_text}"
        else:
            prompt = f"Generate me a report that includes 1) latest industry market trend with data, 2) Profitability of the industry, 3) Potential financial products HSBC can provide to companies in this industry with rationale ,4) top 100 companies in the {user_input_industry} industry in table format (include chinese, english name, stock code if listed, market capitalization, revenue in USD, office headquarter, webiste, what business they are doing, business breakdown by region (make it up), contact person (make it up if you have no information), phone number(make it up if you have no information)), only include those companies based in {user_input_regions}. Use your own knowledge and internet sources. Additionally, include information from these search results: {search_text}"
